...
import static com.dachang.daka.web.rest.TestUtil.sameInstant;
...
public class EntryResourceIntTest {
    ...
    public void createEntry() throws Exception {
        ...
        assertThat(testEntry.getData()).isEqualTo(DEFAULT_DATA);
    }
    ...
    public void updateEntry() throws Exception {
        ...
        assertThat(testEntry.getData()).isEqualTo(UPDATED_DATA);
    }
